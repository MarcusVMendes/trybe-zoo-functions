...
A proposta do projeto é a resolução de problemas lógicos utilizando JavaScript ES6 e Higher Order Functions.
...
- Interpretar testes unitários e produzir soluções que atendam a eles.<br><br>
...
```javascript
cd projetos
git clone git@github.com:MarcusVMendes/trybe-zoo-functions.git
```
<br>
